...
class CoarseInitializer {
 public:
  ...
  bool trackFrame(FrameHessian* newFrameHessian, FrameHessian* newFrameHessian_Right,
 ...
 private:
  ...
  Vec3f calcResAndGS(int lvl, Mat88f& H_out, Vec8f& b_out, Mat88f& H_out_sc, Vec8f& b_out_sc, SE3 refToNew,
